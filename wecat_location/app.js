...
app.get("/friend_list",(req,res)=>{
    ...
    pool.getConnection((err,conn)=>{
       ...
       var sql="SELECT fid,fname,fmsg,msg,subtime,upic FROM (\n" +
           "SELECT o.fid,o.fname,o.msg,o.fmsg,o.subtime,u.upic FROM\n" +
           account+" o,user u WHERE o.fid=u.uid ORDER BY o.subtime desc) " +
           "temp GROUP BY fid ORDER BY subtime desc; ";
